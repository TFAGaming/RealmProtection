package xtremelands.commands.listeners;
...
import xtremelands.managers.ParticleSpawner;

public class ChunksProtectionListener implements Listener {
    // Block place
    @EventHandler
    public void onBlockPlace(BlockPlaceEvent event) {
        ...
        if (ChunksManager.isChunkClaimed(chunk)) {
            ...
            if (!player.getName().equalsIgnoreCase(land_owner_name) && !LandMembersManager
                ...
                xtremelands.Plugin._sendMessageWithTimeout(player, "placeblocks");
    ...
    public void onBlockBreak(BlockBreakEvent event) {
        ...
        if (ChunksManager.isChunkClaimed(chunk)) {
            ...
            if (!player.getName().equalsIgnoreCase(land_owner_name) && !LandMembersManager
                ...
                event.setCancelled(true);
                xtremelands.Plugin._sendMessageWithTimeout(player, "breakblocks");
            ...
            if (ChunksManager.isChunkClaimed(chunk)) {
                ...
                if (!player.getName().equalsIgnoreCase(land_owner_name)
                        && !LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id),
                                ...
                                "containers")) {
                    event.setCancelled(true);
                    xtremelands.Plugin._sendMessageWithTimeout(player, "containers");
                }
            }
            ...
            if (ChunksManager.isChunkClaimed(chunk)) {
                ...
                if (!player.getName().equalsIgnoreCase(land_owner_name)
                        && !LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id),
                                ...
                                "useanvil")) {
                    event.setCancelled(true);
                    xtremelands.Plugin._sendMessageWithTimeout(player, "useanvil");
                }
            }
        }
    }
        ...
        if (ChunksManager.isChunkClaimed(chunk)) {
            ...
            if (!player.getName().equalsIgnoreCase(land_owner_name)
                    && !LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id), player.getName(),
                            "emptybuckets")) {
                event.setCancelled(true);
                xtremelands.Plugin._sendMessageWithTimeout(player, "emptybuckets");
    ...
    public void onPlayerBucketFill(PlayerBucketFillEvent event) {
        ...
        if (ChunksManager.isChunkClaimed(chunk)) {
            ...
            if (!player.getName().equalsIgnoreCase(land_owner_name) && !LandMembersManager
                ...
                event.setCancelled(true);
                xtremelands.Plugin._sendMessageWithTimeout(player, "fillbuckets");
                ...
                if (ChunksManager.isChunkClaimed(chunk)) {
                    ...
                    if (!player.getName().equalsIgnoreCase(land_owner_name)
                            && !LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id), player.getName(),
                                    "harvestcrops")) {
                        event.setCancelled(true);
                        xtremelands.Plugin._sendMessageWithTimeout(player, "harvestcrops");
                ...
                if (ChunksManager.isChunkClaimed(chunk)) {
                    ...
                    if (!player.getName().equalsIgnoreCase(land_owner_name)
                            && !LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id), player.getName(),
                                    "frostwalker")) {
                        event.setCancelled(true);
                        xtremelands.Plugin._sendMessageWithTimeout(player, "frostwalker");
    ...
    public void onPlayerShearEntity(PlayerShearEntityEvent event) {
        ...
        System.out.println("SHEAR FIRED");
        ...
        if (ChunksManager.isChunkClaimed(chunk)) {
            ...
            if (!player.getName().equalsIgnoreCase(land_owner_name) && !LandMembersManager
                ...
                xtremelands.Plugin._sendMessageWithTimeout(player, "shearentities");
                event.setCancelled(true);
            }
        }
    }
    ...
    public void onBlockIgnite(BlockIgniteEvent event) {
        ...
        if (ChunksManager.isChunkClaimed(chunk)) {
            ...
            if (!player.getName().equalsIgnoreCase(land_owner_name) && !LandMembersManager
                ...
                event.setCancelled(true);
                xtremelands.Plugin._sendMessageWithTimeout(player, "createfire");
        ...
        if (ChunksManager.isChunkClaimed(chunk)) {
            ...
            if (entity instanceof Player && damager instanceof Player) {
                if (!LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id), damager.getName(),
                        "pvp")) {
                    event.setCancelled(true);
                    xtremelands.Plugin._sendMessageWithTimeout((Player) damager, "pvp");
                ...
                if (!LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id), damager.getName(),
                        "damagehostilemobs")) {
                    event.setCancelled(true);
                    xtremelands.Plugin._sendMessageWithTimeout((Player) damager, "damagehostilemobs");
                ...
                if (!LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id), damager.getName(),
                        "damagepassivemobs")) {
                    event.setCancelled(true);
                    xtremelands.Plugin._sendMessageWithTimeout((Player) damager, "damagepassivemobs");
                ...
                if (material.name().contains("TRAPDOOR")) {
                    if (!player.getName().equalsIgnoreCase(land_owner_name)
                            && !LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id), player.getName(),
                                    "trapdoors")) {
                        event.setCancelled(true);
                        xtremelands.Plugin._sendMessageWithTimeout(player, "trapdoors");
                    ...
                    if (!player.getName().equalsIgnoreCase(land_owner_name)
                            && !LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id), player.getName(),
                                    "doors")) {
                        event.setCancelled(true);
                        xtremelands.Plugin._sendMessageWithTimeout(player, "doors");
                    ...
                    if (!player.getName().equalsIgnoreCase(land_owner_name)
                            && !LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id), player.getName(),
                                    "editsigns")) {
                        event.setCancelled(true);
                        xtremelands.Plugin._sendMessageWithTimeout(player, "editsigns");
                    ...
                    if (!player.getName().equalsIgnoreCase(land_owner_name)
                            && !LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id), player.getName(),
                                    "buttons")) {
                        event.setCancelled(true);
                        xtremelands.Plugin._sendMessageWithTimeout(player, "buttons");
                    ...
                    if (!player.getName().equalsIgnoreCase(land_owner_name)
                            && !LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id), player.getName(),
                                    "fencegates")) {
                        event.setCancelled(true);
                        xtremelands.Plugin._sendMessageWithTimeout(player, "fencegates");
                    ...
                    if (!player.getName().equalsIgnoreCase(land_owner_name)
                            && !LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id), player.getName(),
                                    "levers")) {
                        event.setCancelled(true);
                        xtremelands.Plugin._sendMessageWithTimeout(player, "levers");
                    ...
                    if (!player.getName().equalsIgnoreCase(land_owner_name)
                            && !LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id), player.getName(),
                                    "redstone")) {
                        event.setCancelled(true);
                        xtremelands.Plugin._sendMessageWithTimeout(player, "redstone");
                    ...
                    if (!player.getName().equalsIgnoreCase(land_owner_name)
                            && !LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id), player.getName(),
                                    "bells")) {
                        event.setCancelled(true);
                        xtremelands.Plugin._sendMessageWithTimeout(player, "bells");
                    ...
                    if (!player.getName().equalsIgnoreCase(land_owner_name)
                            && !LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id), player.getName(),
                                    "usecauldron")) {
                        event.setCancelled(true);
                        xtremelands.Plugin._sendMessageWithTimeout(player, "usecauldron");
                    ...
                    if (block != null && block.getType().name().contains("PRESSURE_PLATE")) {
                        if (!player.getName().equalsIgnoreCase(land_owner_name)
                                && !LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id),
                                        ...
                                        "pressureplates")) {
                            event.setCancelled(true);
                            xtremelands.Plugin._sendMessageWithTimeout(player, "pressureplates");
                        ...
                        if (block.getType() == Material.TRIPWIRE) {
                            if (!player.getName().equalsIgnoreCase(land_owner_name)
                                    && !LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id),
                                            ...
                                            "tripwires")) {
                                event.setCancelled(true);
                                xtremelands.Plugin._sendMessageWithTimeout(player, "tripwires");
            ...
            if (ChunksManager.isChunkClaimed(chunk)) {
                ...
                if (!player.getName().equalsIgnoreCase(land_owner_name)
                        && !LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id), player.getName(),
                                "armorstands")) {
                    event.setCancelled(true);
                    xtremelands.Plugin._sendMessageWithTimeout(player, "armorstands");
            ...
            if (ChunksManager.isChunkClaimed(chunk)) {
                ...
                if (!player.getName().equalsIgnoreCase(land_owner_name)
                        && !LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id), player.getName(),
                                "itemframes")) {
                    event.setCancelled(true);
                    xtremelands.Plugin._sendMessageWithTimeout(player, "itemframes");
        ...
        if (ChunksManager.isChunkClaimed(chunk)) {
            ...
            if (land_owner_name != player.getName()
                    && !LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id), player.getName(),
                            "pickupitems")) {
                event.setCancelled(true);
                xtremelands.Plugin._sendMessageWithTimeout(player, "pickupitems");
    ...
    public void onPlayerPickupItem(PlayerDropItemEvent event) {
        ...
        if (ChunksManager.isChunkClaimed(chunk)) {
            ...
            if (!LandMembersManager.hasPlayerThePermissionToDo(new Integer(land_id), player.getName(),
                    "pickupitems")) {
                event.setCancelled(true);
                xtremelands.Plugin._sendMessageWithTimeout(player, "pickupitems");
