            ...
            if (!LandsManager.hasLand(player.getName())) {
                ...
                if (args.length == 3) {
                    Inventory inventory = Bukkit.createInventory(player, 9 * 6,
                            ColoredString.translate("&9Role Flags"));
                    ...
                    ItemStack roleNameButton = new ItemStack(Material.PAPER);
                    ItemMeta roleNameButtonMeta = roleNameButton.getItemMeta();
                    roleNameButtonMeta.setDisplayName(ColoredString.translate("&6Role: &f" + args[2]));
